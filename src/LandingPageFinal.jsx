        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              {[
                { icon: Users, label: 'Implementation Team', cost: '$147K', desc: '800+ hours chasing vendors, updating spreadsheets, firefighting delays', color: '#2563eb' },
                { icon: Building2, label: 'Vendor/Integration Costs', cost: '$115K', desc: 'Credentialing, EHR setup, billing, compliance, payor enrollment', color: '#2563eb' },
                { icon: Clock, label: 'Revenue Delays & Rework', cost: '$55K', desc: '30-60 day credentialing delays = lost billable revenue', color: '#2563eb' }
              ].map((item, i) => (
                <div key={i} style={{
                  padding: '20px',
                  background: '#f8fafc',
